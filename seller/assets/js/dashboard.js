(function ($) {
  ...
  if ($("#traffic-chart").length) {
    ...
    const shipped = parseInt(document.getElementById("Shipped").innerHTML) || 0;
    console.log(shipped);
    const processing = parseInt(document.getElementById("Processing").innerHTML) || 0;
    const delivered = parseInt(document.getElementById("Delivered").innerHTML) || 0;
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                data: [shipped, processing, delivered],
                backgroundColor: [gradientStrokeBlue, gradientStrokeGreen, gradientStrokeRed],
                hoverBackgroundColor: [
                    gradientStrokeBlue,
                    gradientStrokeGreen,
